...
#ifndef TextShape_HEADER
#define TextShape_HEADER
...
namespace GeometryDisplay {
	...
	class TextShape : public GeometryDisplay::DrawObject, public sf::Transformable {
	public:

		TextShape* clone() override;
		...
		///
		////////////////////////////////////////////////////////////
		TextShape(const String& string, const Font& font, unsigned int characterSize = 30);
